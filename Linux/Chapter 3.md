...
- Terminal GUI là một chương trình trong môi trường GUI mô phỏng cửa sổ Terminal. Có thể truy cập thiết bị đầu cuối GUI thông qua hệ thống menu. Ví dụ, trên máy CentOS, bạn có thể nhấp vào Ứng dụng trên thanh menu, sau đó chọn Công cụ hệ thống > và cuối cùng là Terminal. Nếu bạn có công cụ tìm kiếm, bạn có thể tìm kiếm "Terminal", như được hiển thị ở đây.

![](https://ndg-content-dev.s3.amazonaws.com/media/images/linux-essentials-v2/LEv2_3_1.png)

- Một Terminal ảo có thể chạy đồng thời với giao diện đồ họa người dùng (GUI) nhưng yêu cầu người dùng đăng nhập thông quaTerminal ảo trước khi có thể thực thi các lệnh (giống như trước khi truy cập giao diện GUI).
...
Nhân Linux có thể chạy nhiều loại phần mềm trên nhiều nền tảng phần cứng khác nhau. Một máy tính có thể hoạt động như một máy chủ, nghĩa là nó chủ yếu xử lý dữ liệu thay mặt người khác, hoặc như một máy tính để bàn, nghĩa là người dùng tương tác trực tiếp với nó. Máy có thể chạy phần mềm hoặc được sử dụng như một máy phát triển trong quá trình tạo phần mềm. Một máy thậm chí có thể đảm nhận nhiều vai trò vì Linux không phân biệt; đó chỉ đơn thuần là vấn đề cấu hình các ứng dụng nào được chạy.

Một lợi thế là Linux có thể mô phỏng hầu hết mọi khía cạnh của môi trường sản xuất, từ phát triển đến thử nghiệm, đến xác minh trên phần cứng thu nhỏ, giúp tiết kiệm chi phí và thời gian. Một quản trị viên Linux có thể chạy các ứng dụng máy chủ tương tự trên máy tính để bàn hoặc máy chủ ảo giá rẻ mà các nhà cung cấp dịch vụ internet lớn đang sử dụng. Tất nhiên, máy tính để bàn sẽ không thể xử lý khối lượng dữ liệu tương tự như một nhà cung cấp lớn, nhưng hầu hết mọi cấu hình đều có thể được mô phỏng mà không cần phần cứng mạnh mẽ hoặc giấy phép máy chủ.

Phần mềm Linux thường được chia thành ba loại sau:

***Ứng dụng máy chủ***
	Phần mềm không tương tác trực tiếp với màn hình và bàn phím của máy tính mà nó chạy trên đó. Mục đích của nó là cung cấp thông tin cho các máy tính khác, được gọi là máy khách. Đôi khi các ứng dụng máy chủ có thể không giao tiếp với các máy tính khác mà chỉ ngồi đó và xử lý dữ liệu.

***Ứng dụng máy tính để bàn***
	Trình duyệt web, trình soạn thảo văn bản, trình phát nhạc hoặc các ứng dụng khác mà người dùng tương tác trực tiếp. Trong nhiều trường hợp, chẳng hạn như trình duyệt web, ứng dụng đang giao tiếp với máy chủ ở đầu bên kia và diễn giải dữ liệu. Đây là phía “máy khách” của một ứng dụng máy khách/máy chủ.

***Công cụ***
	Một loại phần mềm chung chung tồn tại để giúp quản lý hệ thống máy tính dễ dàng hơn. Công cụ có thể giúp cấu hình màn hình, cung cấp một shell Linux mà người dùng nhập lệnh vào, hoặc thậm chí các công cụ phức tạp hơn, được gọi là trình biên dịch, chuyển đổi mã nguồn thành các chương trình ứng dụng mà máy tính có thể thực thi.

Tính khả dụng của các ứng dụng khác nhau tùy thuộc vào bản phân phối. Thông thường, các nhà cung cấp ứng dụng chọn một tập hợp con các bản phân phối để hỗ trợ. Các bản phân phối khác nhau có các phiên bản khác nhau của các thư viện chính, và rất khó để một công ty hỗ trợ tất cả các phiên bản khác nhau này. Tuy nhiên, một số ứng dụng như Firefox và LibreOffice được hỗ trợ rộng rãi và có sẵn cho tất cả các bản phân phối Linux chính.

Cộng đồng Linux đã đưa ra nhiều giải pháp sáng tạo cho cả ứng dụng máy tính để bàn và máy chủ. Những ứng dụng này, nhiều trong số đó tạo nên xương sống của Internet, rất quan trọng để hiểu và tận dụng sức mạnh của Linux.

Hầu hết các tác vụ điện toán có thể được thực hiện bởi nhiều ứng dụng khác nhau trong Linux. Có rất nhiều trình duyệt web, máy chủ web, máy chủ cơ sở dữ liệu và trình soạn thảo văn bản để lựa chọn. Đánh giá phần mềm ứng dụng là một kỹ năng quan trọng mà người quản trị Linux tương lai cần học. Xác định các yêu cầu về hiệu suất, độ ổn định và chi phí chỉ là một số trong những cân nhắc cần thiết cho một phân tích toàn diện.
## 3.2.2 Server Applications

Linux vượt trội trong việc chạy các ứng dụng máy chủ vì độ tin cậy và hiệu quả của nó. Khả năng tối ưu hóa hệ điều hành máy chủ chỉ với các thành phần cần thiết cho phép quản trị viên làm được nhiều việc hơn với ít chi phí hơn, một tính năng được các công ty khởi nghiệp cũng như các doanh nghiệp lớn yêu thích.
