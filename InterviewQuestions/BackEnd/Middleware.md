...
1. **Thành phần xử lý phản hồi:**
	- Middleware cũng có thể sử đổi phản hồi trước khi gửi nó trở lạ máy khách.
2. **Pipeline:**
...
public void Configure(IApplicationBuilder app, IWebHostEnviroment env){
	if(env.IsDevelopment()){
		app.UseDeveloperExxceptionPage();  //Hiển thị chi tiết lỗi khi phát triển
	}else{
...
public void ConfigureServices(IServiceCollection services){
	services.Cònigure<CookiePolicyOptions>(options => {
...
```
### **14. Giải thích về Custom Middleware?**
