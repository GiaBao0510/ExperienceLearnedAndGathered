...
- **Entity Framework (EF)** là một công nghệ **ORM (Pbkect-Relactional Mapping)** của Microsoft giúp cho các lập trình viên có thể thao tác với cơ sở dữ liệu một cách dễ dàng hơn. Thay vì phải viết các câu lệnh SQL thủ công thì có thể sử dụng đối tượng trong mã nguồn để tương tác với cơ sở dữ liệu.
...
- È có thể gây khó khăn khi sử dụng có quá nhiều ánh xạ và quan hệ phức tạp.
